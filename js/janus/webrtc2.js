                        ...
                        janus.attach(
                            {
                                ...
                                success: function (pluginHandle) {
                                    ...
                                    var register = { "request": "join", "room": myroom, "ptype": "publisher", "display": myuser.username, id:myuser.id };
                                        ...
                                        if (event === "joined") {
                                            ...
                                            if (msg["publishers"] !== undefined && msg["publishers"] !== null) {
                                                ...
                                                if (msg["error_code"] === 426) {
                                                    ...
                                                    alert('the one this demo uses as a test room');
                                                } else {
                                ...
                                onlocalstream: function (stream) {
                                    ...
                                    if (videoTracks === null || videoTracks === undefined || videoTracks.length === 0) {
                                        ...
                                        if (jQuery('#myvideo').length === 0) {
                                            var el = '<video id="myvideo" width="100%" height="100%" autoplay playsinline muted="muted"></video>\
...
function publishStream(_myvideoDOMContainer){
