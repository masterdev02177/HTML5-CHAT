...
$webmasterid = (isset($args[0]))?$args[0]:WEBMASTERID;
...
if ($args && strlen($args[1])>120) {
    ...
    $myuser['password'] = '';
    $myuser['credits'] = intval( $myuser['credits']);
...
$scriptChat = ((basename(__FILE__))!='chat2.php')?"js/chatHTML54live.js?cache=".rand():"js/chatHTML54live.js?cache=".rand();
