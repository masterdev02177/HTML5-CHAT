...
class Xcrud_config
{
    ...
    // alert settings
    public static $email_from = 'mailer@nextechangisme.com'; // email from address
    public static $email_from_name = 'nextechangisme.com'; // email from name
	...
	public static $editor_url = 'editors/ckeditor/ckeditor.js'; // URL path to editor script, if you want to use the visual editor.

    public static $scripts_url = 'xcrud'; // URL to the xCRUD folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/xcrud' or absolute, e.g. 'http://www.your_site.com/some_folder/xcrud'. If empty - will be detected automatically
