...
$xcrud->columns('username, credits, role');
$xcrud->fields('username, credits, role', false, 'Global');
$xcrud->button('conferenceReportsDetail.php?userid={userid}', 'details', 'icon-link');
