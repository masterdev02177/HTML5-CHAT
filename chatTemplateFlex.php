...
<head>
    ...
    <link rel="stylesheet" href="css/mode/<?= $config->chatType ?>.css?cache=<?= time() ?>">
    ...
    <?php if ($config->externalJS && filter_var($config->externalJS, FILTER_VALIDATE_URL) !== false) : ?>
        <script src="<?= $config->externalJS ?>?cache=<?= time() ?>"></script>
    <?php endif ?>
    <link rel="stylesheet" href="css/flex.css?cache=<?= time() ?>">
    <style>
        <?= $config->css ?>
    </style>
            ...
            <div class="flex-property group-btns header-custom-btns">
                ...
                <?php if ($config->displayPrivateButton) : ?>
                    <div class="header-btn-wrap flex-property" title="<?= $traductions["do not disturb with private requests"]; ?>">
                        ...
                        <input type="checkbox" id="acceptPrivateCheckBox" checked <?php /*if (!$config->privateOnlyOnInvitation) echo 'checked';*/ ?> data-toggle="toggle" data-on="" data-off="" data-onstyle="success" data-offstyle="danger">
                    </div>
                <?php endif ?>
                ...
                <div class="header-btn-wrap flex-property soundsEffects" title="<?= $traductions['do not play sound effects']; ?>">
                    ...
                    <input class="pull-right" type="checkbox" checked id="soundCheckBox" data-toggle="toggle" data-on="" data-off="" data-onstyle="success" data-offstyle="danger">
                </div>
            </div>
        </div>
        <div id="container">
                ...
                <div id="chatContainer">
                    ...
                    <div id="footer" class="flex-property">
                        <div class="textarea-icons-wrapper flex-property">
                            ...
                            <div class="dropup">
                                <div class="chat-input-icons dropbtn" id="biggerDiv" title="Bigger_text">
                                    <i class="fa fa-text-height"></i>
                                </div>
                                <div class="dropup-content">
                                    <a href="#" class="fontsize-select">10</a>
                                    <a href="#" class="fontsize-select">12</a>
                                    <a href="#" class="fontsize-select">15</a>
                                    <a href="#" class="fontsize-select">20</a>
                                    <a href="#" class="fontsize-select">25</a>
                                    <a href="#" class="fontsize-select">30</a>
                                </div>
                            </div>
                                ...
                                <div id="searchRoomContainer" class="flex-property search-bar">
                                    <?php if ($config->showSearchRoomAdultCheckbox) : ?>
                                        ...
                                        <?php if (isset($myuser['showAdultrooms'])) : ?>
                                            ...
                                            <input type="checkbox" id="adultRoomCheckBox" checked data-toggle="toggle" data-on="" data-off="" data-onstyle="success" data-offstyle="danger">
                                        <?php endif; ?>
                                    <?php endif ?>
                                </div>
